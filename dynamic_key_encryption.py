...
# Example usage:
app_key = input("Enter App Key: ") # iYITUogblJiSlvjfuKOILCeqApWP_8nDRFNLBhSh1WI
secret_key = input("Enter Secret Key: ") # "PO6LUi97w-MokPDBycTfl1a1jN4Vck3jNCBYSAhd76UWv5ObhTt0zqdg4NFzb_baLmr-ZwmeY1CYcXtep883kA"
data = {
    "customer_id": random.randint(1, 10000000),
    "order_id": f"askjgksa_{random.randint(1, 100000)}",
    "bank_name": "bkash",
    "sending_amount": 1000,
    "sending_currency": "BDT",
